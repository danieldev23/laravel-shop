          ...
          <div class="wrap-table-shopping-cart">
            ...
            <table class="table-shopping-cart">
              ...
              <tr class="table_row">
                ...
                <td class="column-3">{{ number_format($price)  }} VNĐ</td>
                <td class="column-4">
...
@else
<div class="text-center"><h2><b>Giỏ hàng trống
<div><textarea name="" id="" cols="30" rows="10">Vui lòng mua hàng ^^</textarea></div>
</b></h2></div>
@endif
@endsection