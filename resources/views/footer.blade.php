		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<div class="p-t-27">
						<a href="https://www.facebook.com/DocsachcungJulie" target="_blank" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<form>
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="Email của bạn">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Đã đăng ký bản quyền | Thiết kế <i class="fa fa-heart-o" aria-hidden="true"></i> bởi <a href="https://facebook.com/huycoder2k5" target="_blank">Đặng Quốc Huy</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
